...
- [Locks in Java](#locks-in-java)
  - [A Simple Lock](#a-simple-lock)
  - [Lock Reentrance](#lock-reentrance)
  - [Lock Fairness](#lock-fairness)
  - [Calling unlock() From a finally-clause](#calling-unlock-from-a-finally-clause)
