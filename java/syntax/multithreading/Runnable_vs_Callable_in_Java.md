...
- [Runnable vs. Callable in Java](#runnable-vs-callable-in-java)
  - [1. Overview](#1-overview)
  - [2. Execution Mechanism](#2-execution-mechanism)
  - [3. Return Values](#3-return-values)
    - [3.1. With Runnable](#31-with-runnable)
    - [3.2. With Callable](#32-with-callable)
  - [4. Exception Handling](#4-exception-handling)
    - [4.1. With Runnable](#41-with-runnable)
    - [4.2. With Callable](#42-with-callable)
...
Both interfaces are designed to represent a task that can be executed by multiple threads. `Runnable` tasks can be run using the `Thread` class or `ExecutorService` whereas `Callable`s can be run only using the latter.
