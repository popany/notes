...
- [Memory Barriers Are Like Source Control Operations](#memory-barriers-are-like-source-control-operations)
  - [Types of Memory Barrier](#types-of-memory-barrier)
    - [#LoadLoad](#loadload)
    - [#StoreStore](#storestore)
    - [#LoadStore](#loadstore)
    - [#StoreLoad](#storeload)
  - [How Far Does This Analogy Get You?](#how-far-does-this-analogy-get-you)
...
- Many operations on [C++11 atomic types](http://en.cppreference.com/w/cpp/atomic/atomic), such as `load(std::memory_order_acquire)`
...
![fig1](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/cpu-diagram.png)
...
![fig2](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/source-control-analogy.png)
...
![fig3](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/marked-example2-2.png)
...
![fig4](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/iriw-state.png)
...
![fig5](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/barrier-types.png)
...
![fig6](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/loadload.png)
...
![fig7](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/storestore.png)
...
![fig8](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/get-back-to-later.png)
...
![fig8](./fig/Memory_Barriers_Are_Like_Source_Control_Operations/storeload.png)
