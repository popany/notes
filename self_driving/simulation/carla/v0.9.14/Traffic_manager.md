# [Traffic manager](https://carla.readthedocs.io/en/0.9.14/tuto_G_traffic_manager/)

- [Traffic manager](#traffic-manager)
  - [Setting up the simulator and initialising traffic manager](#setting-up-the-simulator-and-initialising-traffic-manager)
  - [Spawning vehicles](#spawning-vehicles)
  - [Controlling vehicles with Traffic Manager](#controlling-vehicles-with-traffic-manager)
  - [Specify routes for vehicles](#specify-routes-for-vehicles)
